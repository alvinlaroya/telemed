...
<html>
    ...
    <body>
        ...
        <hr>
        <div class="wrapper">
            <h2>Appointment Information Details</h2>
            ...
            @endif
            <p><span class="heading-details">Amount Paid: </span> &#8369;{{ number_format($center->amount_paid, 2) }}</p>

            <p><span style="font-weight: bold;">Payment Reference No: </span> {{ $booking->payment_ref }}</p>
        </div>
    </body>
</html>
