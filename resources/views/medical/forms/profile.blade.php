<form action="{{ route('medical.doctors.profile.update', array('doctor' => $doctor)) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        @if($doctor->picture)
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select name="specializations[]" class="form-control @error('specializations') is-invalid @enderror" id="specializationDropdown" data-action="{{ route('medical.specializations.index') }}" data-value="{{ old('specializations') ? implode(',', old('specializations')) : $doctor->specializations()->pluck('specializations.id')->implode(',') }}">
                        </select>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select name="hmos[]" class="form-control @error('hmos') is-invalid @enderror" id="accreditationDropdown" data-action="{{ route('medical.hmo-accreditations.index') }}" data-value="{{ old('hmos') ? implode(',', old('hmos')) : $doctor->hmos()->pluck('hmo_accreditations.id')->implode(',') }}">
                        </select>
                        @error('hmos')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
        ...
        <div class="col-12 col-md">
            <div class="form-group">
                ...
                <div class="row @error('clinic_days') is-invalid @enderror">
                    @php
                        $clinicDays = array(1 => 'Mon', 2 => 'Tue', 3 => 'Wed', 4 => 'Thu', 5 => 'Fri', 6 => 'Sat');
                    @endphp
