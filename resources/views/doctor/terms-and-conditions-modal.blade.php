    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="padding: 1rem !important;">
                <h5 class="modal-title font-weight-bold" id="termsAndConditionModalLabel">TERMS AND CONDITIONS OF USE:</h5>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btnAgreeAndContinue">Agree and Continue</button>
            </div>
        </div>
    </div>
</div>