    ...
    <div class="row">
        ...
        <div class="col-auto" style="margin-top: 30px">
            ...
            @if(request()->has('search'))
                <a href="{{ route('patient.reports.transactions') }}" class="btn btn-danger ml-2">Reset</a>
            @endif
        </div>
        <div class="col-auto" style="margin-top: 30px">
...
<table class="table table-striped">
  ...
  <tbody>
    @if(count($bookings) > 0)
        ...
        <tr>
            <td><a href="{{ route('patient.servicesBooking.show', $booking) }}">{{ $booking->booking_reference_no }}</a></td>
