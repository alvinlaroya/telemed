...
@section('content')
    <div class="py-5 text-center">
        <h1>{{ $patient->name }} | Screening Form | {{ date('M-d-Y') }}</h1>
    </div>
    <form class="patientScreeningForm" action="{{ route('re-screening-submit', array('patient' => $patient, 'booking' => $booking, 'hash' => $hash)) }}" data-save="{{ route('re-screening-failed') }}" method="post">
        @csrf
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                ...
                <div class="button-wrapper">
                    ...
                    <a href="" type="button" class="btn btn-secondary float-left">Back</a>
