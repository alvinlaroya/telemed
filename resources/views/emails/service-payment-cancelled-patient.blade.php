...
<p></p>
<p>Your payment for appointment reference # {{ $booking->booking_reference_no }} has cancelled.</p>
...
If you wish to book again, please go to <a href="{{ route('bookingService') }}">{{ route('bookingService') }}</a>
