...
<head>
    ...
    <meta name="description"
        content="Enter a new era in healthcare with MyHospital, where we transform everyone’s access to healthcare. Visit our site to learn more about MyHospital.">
    <meta name="author" content="">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Telemed Healthcare Services | MyHospital</title>
...
<body>
    ...
    <section id=main>
        <h1 style="display: none;">MyHospital: A New Era in Healthcare</h1>
        @yield('content')
    </section>
    <footer>
        <div class="container">
