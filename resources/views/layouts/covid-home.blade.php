...
<head>
    ...
    <meta name="description"
        content="At MyHospital, we improve the experience of both patients and doctors in handling mild and asymptomatic cases of COVID-19. Contact us today!">
    <meta name="author" content="">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>COVID-19 Care Specialty Center | MyHospital</title>
...
<body>
    ...
    <section id=main>
        <h1 style="display: none;">COVID-19 Testing and Care Services</h1>
        @yield('content')
    </section>
    <footer>
        <div class="container">
