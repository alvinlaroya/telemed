...
<form class="patientScreeningForm" action="" data-save="{{ route('save-patient-screening-update') }}" method="post">
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="button-wrapper screeningButtons">
                        ...
                        <button type="button" class="btnSets btn-intro btn btn-primary btn-lg">Next</button>
                        <button type="button" class="btnSets btn-hasCompanion btn btn-primary btn-lg" style="display:none">Next</button>
                        <button type="button" class="btnSets btn-companionDetails btn btn-primary btn-lg" style="display:none">Next</button>
                        <button type="button" class="btnSets btn-patientQuestion btn btn-primary btn-lg" style="display:none">Next</button>
                        <button type="button" class="btnSets btn-setOne btn btn-primary btn-lg" style="display:none">Next</button>
                        <button type="button" class="btnSets btn-setTwo btn btn-primary btn-lg" style="display:none">Next</button>
                        <button type="button" class="btnSets btn-setThree btn btn-primary btn-lg" style="display:none">Next</button>
                        <button type="button" class="btnSets btn-setFour btn btn-primary btn-lg" style="display:none">Next</button>
                    </div>
                </div>
            </div>
        </div>
