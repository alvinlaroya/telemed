<div class="row">
    <div class="col-12">
        <form id="patientForm" action="{{ route('book-doctor.save') }}" method="POST" class="needs-validation"
            novalidate enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="isHomeVisit" value="{{ request('isHomeVisit') }}">
            ...
            <input type="hidden" name="authenticated" value="{{ $message }}" />
            <input type="hidden" name="patient_id" value="{{ isset($patient_id) ? $patient_id : '' }}" />
            <h3 class="mb-3">To book your appointment, create your profile</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="mobile" class="form-control int-phone" id="mobile" placeholder="" value=""
                        required>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="seniorPWD">Check this box if you are Senior Citizen or
                            PWD.</label>
                    </div>
                </div>
                <div class="col-md-6 mb-3 displayIDNo">
                    <label for="idNumber">ID Number</label><span class="note">Please bring your Senior Citizen ID/PWD ID
                        during your visit for validation.</span>
                    <input type="text" name="idNumber" class="form-control" id="idNumber" placeholder="ID Number"
                        value="">
                ...
                <div class="col-md-3 mb-3 seniorPwdID">
                    ...
                    <input type="file" name="seniorPwdID" class="form-control" id="seniorPwdID"
                        placeholder="Senior/PWD ID" value="">
                ...
                <div class="col-md-3 mb-3 seniorPwdIDBack">
                    ...
                    <input type="file" name="seniorPwdIDBack" class="form-control" id="seniorPwdIDBack"
                        placeholder="Senior/PWD ID" value="">
                    <div class="invalid-feedback">File attachment is required.</div>
                </div>
            </div>
            {{-- <div class="form-group">
                ...
                <textarea name="complaint" id="complaint" class="form-control" rows="5"></textarea>
                    ...
                    @foreach ($customFields as $fields)
                        <div class="col-12 mb-3">
                            @if ($fields->type == 'field')
                                <label for="field_{{ $fields->id }}">
                                    <h5>{{ $fields->question }}</h5>
                                </label>
                                <input type="text" name="fields[{{ $fields->id }}][answer]" class="form-control"
                                    id="field_{{ $fields->id }}" {{ $fields->required ? 'required' : '' }}>
                                <input type="hidden" name="fields[{{ $fields->id }}][type]"
                                    value="{{ $fields->type }}">
                                <input type="hidden" name="fields[{{ $fields->id }}][question]"
                            ...
                            @if ($fields->type == 'text')
                                ...
                                <textarea name="fields[{{ $fields->id }}][answer]" class="form-control"
                                    id="field_{{ $fields->id }}" rows="3"
                                    {{ $fields->required ? 'required' : '' }}></textarea>
                                <input type="hidden" name="fields[{{ $fields->id }}][type]"
                                    value="{{ $fields->type }}">
                                <input type="hidden" name="fields[{{ $fields->id }}][question]"
                                    value="{{ $fields->question }}">
                                ...
                                @foreach ($fields->options as $innerKey => $option)
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"
                                            name="fields[{{ $fields->id }}][arr_answer]"
                                            id="fieldoption_{{ $fields->id . '-' . $innerKey }}"
                                            value="{{ $option }}" {{ $fields->required ? 'required' : '' }}>
                                        <label class="form-check-label"
                                            for="fieldoption_{{ $fields->id . '-' . $innerKey }}">
                                            {{ $option }}
                                        </label>
                                    </div>
                                @endforeach
            ...
            <div class="form-check">
                ...
                <label class="form-check-label required" for="flexCheckDefault">
                    I have read and agree to the site terms of use and data privacy policy. <a href="#"
                        data-toggle="modal" data-target="#terms-of-use">Read more</a>
                </label>
            </div>
            <hr class="mb-4">
            <div class="text-center">
                <button class="btn btn-primary btn-lg" id="submitForm" type="submit" disabled>Submit</button>
...
<div class="modal fade" id="terms-of-use" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="font-size: 15px">
                ...
                <p class="modal-p">
                    MyHospital is neither engaged in the practice of medicine nor is it a provider of health care and/or
                    medical services.
                </p>
                <p class="modal-p">
                ...
                <p class="modal-p">
                    The USER has agreed to avail the services offered by MyHospital and MyHospital has agreed to provide
                ...
                <ol style="list-style-type: lower-latin;">
                    <li>
                        The USER represents and warrants that he is at least eighteen (18) years of age and has the
                        legal capacity to enter into contracts and agreements.
                    </li>
                    <li>
                    ...
                    <li>
                        The USER shall not, under any circumstance, allow a third party to use hi MyHospital account,
                    ...
                    <li>
                        The USER has read and understood the terms and conditions of this Agreement and all other
                        supplementary and amendatory agreements.
                    </li>
                    <li>
                ...
                <ol style="list-style-type: lower-latin;">
                    <li>
                        Term: This Agreement shall be effective upon the USER’s purchase of any of the subscription
                        packages enumerated herein.
                    </li>
                    <li>
                        Termination.
                        By MyHospital:
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                ...
                                <ol style="list-style-type: lower-roman;">
                                    <li>
                                        safeguard, keep, treat and maintain all Confidential Information in strict
                                        confidence;
                                    </li>
                                    <li>
                                        use all Confidential Information solely for the purpose intende whether
                                        expressly or impliedly stated; ; and
                                    </li>
                                    <li>
                                        strictly comply with the provisions of Republic Act No. 10173 otherwise known as
                            ...
                            <li>
                                Exceptions
                                <p class="modal-p">
                                    The confidentiality obligation of this Agreement shall not apply to information
                                    which was received by MyHospital from the USER that:
                                </p>
                                <ol style="list-style-type: lower-roman;">
                                    <li>
                                    ...
                                    <li>
                                        entered the public domain after the time of its disclosure through means other
                                    ...
                                    <li>
                                        was disclosed to MyHospital without restriction by a third party having the full
                                        right to disclose this information;
                                    </li>
                                    <li>
                                        was independently developed by MyHospital without use of the information
                            ...
                            <li>
                                ...
                                <p class="modal-p">
                                    ...
                                    photographs, copies, and all other forms of the Confidential Information disclosed
                                    in
                ...
                <ol style="list-style-type: lower-latin;">
                    ...
                    <li>
                        Any commercial or promotional distribution, publishing or exploitation thereof is strictly
                        prohibited unless expressly permitted by MyHospital.
                    </li>
                    <li>
                ...
                <p class="modal-p">
                    E-conomy, Inc. shall not be liable to any USER of its MyHospital portal for any consequences
                    resulting from:
                </p>
                <ol style="list-style-type: lower-latin;">
                    <li>
                    ...
                    <li>
                        deletion, corruption, or failure to store any user data including those originating from
                        laboratories, diagnostic clinics, hospital, and pharmacies;
                    </li>
                    <li>
                        use of any USER data uploaded by user Physicians, laboratories, diagnostic clinics, hospital,
                        and pharmacies to the MyHospital portal;
                    </li>
                    <li>
                        failure to provide true, accurate, and complete information to MyHospital that may result in
                        inaccurate medical care, diagnosis and treatment;
                    </li>
                    <li>
                    ...
                    <li>
                        the USER’s access of the MyHospital’s portal through the use of browsers other than those
                        recommended, accepted or supported by MyHospital;
                    </li>
                    <li>
                ...
                <ol style="list-style-type: lower-latin;">
                    ...
                    <li>
                        Interchangeability. It is hereby understood that the use of the word “he” in this Agreement
                        shall refer to both the male and female gender.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        Any written communication shall be transmitted by MyHospital to the USER’s email address, postal
                        address, and/or telephone/mobile number.
                    </li>
                    <li>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" id="btnAgreeAndContinue">Agree and
                    Continue</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                    id="agreeAndContinue">Close</button>
            </div>
        </div>
    </div>
</div>
