...
{
	/**
	 * Get weekly schedule for specified doctor.
	 * 
	 * @param  \App\Doctor  $doctor
	 * @param  \Illuminate\Http\Request  $request
	 */
	public function weekSchedule(Doctor $doctor, Request $request)
	{
	 ...
	 * @param  \Illuminate\Http\Request  $request
	 */
	public function newShift(Doctor $doctor, Request $request)
	{
		...
		return $this->weekSchedule($doctor, $request);
	}

	/**
	 * Delete shift of specified doctor.
	 * 
	 * @param  \App\Doctor  $doctor
	 * @param  \App\Schedule  $schedule
	 * @param  \Illuminate\Http\Request  $request
	 */
	public function deleteShift(Doctor $doctor, Schedule $schedule, Request $request)
	{
		$schedule->delete();
	...
	/**
	 * Update specified doctor data in storage.
	 * 
	 * @param  \App\Doctor  $doctor
	 * @param  \App\Schedule  $schedule
	 * @param  \Illuminate\Http\Request  $request
	 */
	public function update(Doctor $doctor, Schedule $schedule, Request $request)
	{
	...
	/**
	 * Set working schedule for specified doctor.
	 * 
	 * @param  \App\Doctor  $doctor
	 * @param  \Illuminate\Http\Request  $request
	 */
	 ...
	 * @param  \App\Schedule  $schedule
	 */
	public function updateStatus(Doctor $doctor, Schedule $schedule, Leave $leave = null, Request $request) 
	{
		if (!$leave) {
	 ...
	 * @param  \Illuminate\Http\Request  $request
	 */
	public function weeklyCopySchedule(Doctor $doctor, Request $request)
	{
	...
	/**
	 * Copy schedule forward of specified doctor.
	 * 
	 * @param  \App\Doctor  $doctor
